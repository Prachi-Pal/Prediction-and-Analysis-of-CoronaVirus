...
with header:
    ...
    st.text("Get prediction of total Covid-19 cases and deaths by choosing the country & the date.")
...
with prediction:
    ...
    html_str = f"""<style>p.a {{font: bold {14}px Courier;}}</style><p class="a">Cumulative Deaths : {cumulative_deaths}</p>"""
    ...
    html_str1 = f"""<style>p.a {{font: bold {14}px Courier;}}</style><p class="a">Cumulative Cases : {cumulative_cases_result}</p>"""
    ...
    html_str1 = f"""<style>p.a {{font: bold {14}px Courier;}}</style><p class="a">Ratio of Cumulative cases and Cumulative Deaths : {ratio_float}</p>"""
    st.markdown(html_str1, unsafe_allow_html=True)
    
    html_str1 = f"""<style>p.a {{font:{14}px Courier;}}</style><p class="a">Higher the ratio for cumulative cases and cumulative deaths better is the Health Infrastructure of the {Country}</p>"""
    st.markdown(html_str1, unsafe_allow_html=True)
